...
# DEFAULTS
###############################################################################
DEFAULT_FASTQ_FOLDER = './fastq_pass/'
DEFAULT_INPUT_FASTQ = 'c_s.fastq'
DEFAULT_OUTPUT_CSV = 'matched_results_2.csv'
DEFAULT_DESIGN_CSV = 'design.csv'

# Adapter trimming
DEFAULT_LIB_LENGTH = 140
DEFAULT_FRONT_PRIMER = "TAAGAGACAG"
DEFAULT_BACK_PRIMER = "CTGTCTCTTA"
DEFAULT_LENGTH_TOLERANCE = 5

# Barcode matching
DEFAULT_BARCODE_START_IDX = 0
DEFAULT_BARCODE_END_IDX = 12  # Reverted to 12
...
def main():
    ...
    # I/O arguments
    parser.add_argument("--fastq_folder", default=DEFAULT_FASTQ_FOLDER,
                            help="Path to input FASTQ FOLDER (default: %(default)s)")
    ...
    for filename in os.listdir(args.fastq_folder):
        if filename.endswith(".fastq"):
            file_path = os.path.join(args.fastq_folder, filename)
